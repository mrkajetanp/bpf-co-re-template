...
all:
	...
	clang -g -O2 -Wall -target bpf -I bpf/usr/include -c $(BINARY).bpf.c -o $(BINARY).bpf.o

	bpftool gen skeleton $(BINARY).bpf.o > $(BINARY).skel.h

	cc -g -O2 -Wall -I bpf/usr/include -c $(BINARY).c -o $(BINARY).o

	cc -g -O2 -Wall -I bpf/usr/include $(BINARY).o bpf/usr/lib64/libbpf.a -lelf -lz -o $(BINARY)
